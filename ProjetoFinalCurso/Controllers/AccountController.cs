...
using ProjetoFinalCurso.Models.Login;
...
using System;
using Response = ProjetoFinalCurso.Helpers.Response;
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    Response response = _mailHelper.SendEmail(model.Username, "Email confirmation", $"<h1>Email Confirmation</h1>" +
                        $"To allow the user, " +
                        $"please click in this link:</br></br><a href = \"{tokenLink}\"  style=\"color: blue\">Confirm Email</a>");
